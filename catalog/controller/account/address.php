...
class ControllerAccountAddress extends Controller {
	...
	public function consultaaddresstbest(){
		$this->load->model('tool/points');
		$returnistbest = $this->model_tool_points->isTbestP();
		if($returnistbest){
			$retornoApi = $this->model_tool_points->getUsuarioTbest($returnistbest['login'], $returnistbest['senha']);
	...
	public function cadastroajax(){
		...
		if($returnistbest){
			...
			if($retornoApi){
				print_r($retornoApi);
				$this->load->model('account/address');
				$this->model_account_address->addAddressAjax($retornoApi);
			}
		}
	}
	...
	public function getAddressJson(){
		...
		$this->response->setOutput(json_encode($data['addresses']));
	}

	public function alterAddressMain(){

		if ($this->request->server['REQUEST_METHOD'] == 'POST'){
			$this->load->model('account/address');
			$this->model_account_address->alterAddressMain($this->request->post['address_id']);
