...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			if ($order_info['id_asaas'] && strpos(strtolower($order_info['payment_method']), 'pix') !== false) {
				$data['qrcodeAsaas'] = $this->gerarqrcode($order_info['id_asaas']);
			}
	...
	public function gerarqrcode($idTransacao){
        ...
        $response = $this->requestapi->api([
            'no_version'=> '',
            'endpoint' => 'payments/'.$idTransacao.'/pixQrCode',
            'content_type' => '',
            'method' => 'GET',
            'auth_type' => '',
            'headers' => [
