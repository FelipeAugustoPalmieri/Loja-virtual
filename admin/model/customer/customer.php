...
class ModelCustomerCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		$senhatbest = ((!empty($this->db->escape($data['senhatbest']))) ? " senhatbest = '" . $this->db->escape($data['senhatbest']) . "'," : "" );
		$this->db->query("UPDATE " . DB_PREFIX . "customer SET customer_group_id = '" . (int)$data['customer_group_id'] . "', logintbest = '" . $this->db->escape($data['logintbest']) . "', " . $senhatbest ." firstname = '" . $this->db->escape($data['firstname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? json_encode($data['custom_field']) : json_encode(array())) . "', newsletter = '" . (int)$data['newsletter'] . "', status = '" . (int)$data['status'] . "', safe = '" . (int)$data['safe'] . "' WHERE customer_id = '" . (int)$customer_id . "'");
